(function (global, factory) {
    ...
    (global.HighlightRainbow = factory());
    ...
    function replaceAtPosition(position, replace, replaceWith, code) {
        ...
        // highlighted code
        //
        // @see https://github.com/ccampbell/HighlightRainbow/issues/208
    ...
    function HighlightRainbowWorker(e) {
        var message = e.data;
    ...
    /**
     * Representation of the actual HighlightRainbow object
     *
     * @type {Object}
     */
    var HighlightRainbow = {};
     ...
     * @see https://github.com/ccampbell/HighlightRainbow/issues/207
     */
    var id = 0;
    ...
    function _getWorker() {
        if (isNode || cachedWorker === null) {
            cachedWorker = createWorker(HighlightRainbowWorker, Prism);
        }
    ...
    function _generateHandler(element, waitingOn, callback) {
        return function _handleResponseFromWorker(data) {
            ...
            element.classList.add('HighlightRainbow-show');

            if (element.parentNode.tagName === 'PRE') {
                element.parentNode.classList.remove('loading');
                element.parentNode.classList.add('HighlightRainbow-show');
            }
    ...
    function _highlightCodeBlocks(codeBlocks, callback) {
        ...
        for (var i = 0, list = codeBlocks; i < list.length; i += 1) {
            ...
            if (block.classList.contains('HighlightRainbow') || !language) {
                continue;
            }
            ...
            block.classList.add('HighlightRainbow');
    ...
    function _highlight(node, callback) {
        ...
        // when using mootools.
        //
        // @see https://github.com/ccampbell/HighlightRainbow/issues/32
        ...
        for (var i = 0, list = preBlocks; i < list.length; i += 1) {
            ...
            if (preBlock.getElementsByTagName('code').length) {
                ...
                // This fixes a race condition when HighlightRainbow.color is called before
    ...
    /**
     * Starts the magic HighlightRainbow
     *
     * @return {void}
     */
    function color() {
        ...
        // Example:
        //
        // HighlightRainbow.color(code, language, function(highlightedCode, language) {
        ...
        // Example:
        //
        // HighlightRainbow.color(function() {
        ...
        // HighlightRainbow.color(preElement, function() {
     ...
     *
     * @see https://github.com/ccampbell/HighlightRainbow/issues/154
     * @param {string} alias
    ...
    if (isNode) {
        HighlightRainbow.colorSync = function(code, lang) {
    ...
    if (!isNode && !isWorker) {
        document.addEventListener('DOMContentLoaded', function (event) {
            if (!HighlightRainbow.defer) {
                HighlightRainbow.color(event);
            }
        }, false);
    }
    ...
    if (isWorker) {
        self.onmessage = HighlightRainbowWorker;
    }

    var HighlightRainbow$1 = HighlightRainbow;

    return HighlightRainbow$1;
